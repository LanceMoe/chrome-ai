...
>(({ asChild, className, ...props }, ref) => {
  ...
  return <Comp ref={ref} className={twMerge('transition-colors hover:text-foreground', className)} {...props} />;
});
...
const BreadcrumbSeparator = ({ children, className, ...props }: React.ComponentProps<'li'>) => (
  <li role="presentation" aria-hidden="true" className={twMerge('[&>svg]:size-3.5', className)} {...props}>
