...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title ref={ref} className={twMerge('text-lg font-semibold text-foreground', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description ref={ref} className={twMerge('text-sm text-muted-foreground', className)} {...props} />
));
